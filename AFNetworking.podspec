Pod::Spec.new do |s|
  ...
  s.homepage = 'https://github.com/ComputerScienceStudentsOrganisation/AFNetworking-GRG'
  s.social_media_url = 'https://twitter.com/AFNetworking'
  s.authors  = { 'Mattt Thompson' => 'm@mattt.me' }
  s.source   = { :git => 'git@github.com:ComputerScienceStudentsOrganisation/AFNetworking-GRG.git', :tag => "2.2.0", :submodules => true }
  s.requires_arc = true
